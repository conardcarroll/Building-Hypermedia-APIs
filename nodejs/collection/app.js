...
/* filters */
app.get('/collection/tasks/;queries',
function(req, res) {
    res.header('content-type', contentType);
    res.render('queries', {
        layout: 'item-layout',
...
app.get('/collection/tasks/;template',
function(req, res) {
    res.header('content-type', contentType);
    res.render('template', {
        layout: 'item-layout',
...
app.get('/collection/tasks/;closed',
function(req, res) {
...
app.get('/collection/tasks/;date-range',
function(req, res) {
